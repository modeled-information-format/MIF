...
These values are pragmatic validity/freshness defaults. The cognitive-memory rationale for tuning them lives in the AI Memory profile. See the [Specification](/specification/overview/) for detailed rationale.
