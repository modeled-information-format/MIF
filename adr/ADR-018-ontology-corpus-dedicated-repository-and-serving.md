...
description: "The ontology definitions live in the dedicated modeled-information-format/ontologies repository as the source of record, while the normative ontology schema and JSON-LD context stay in MIF as the format contract; the corpus is served at mif-spec.dev/ontologies/ with canonical and immutable version-pathed mirrors, mirroring the schema model (ADR-016)."
type: adr
